...
for s in Pilot06; do
	...
	for task in HTBMB2; do
		...
		-stim_times 1 /home/despoB/kaihwang/bin/HTB_MRI/${s}_R4 'TENT(0, 14, 8)' -stim_label 1 R4 \
		-stim_times 2 /home/despoB/kaihwang/bin/HTB_MRI/${s}_R8 'TENT(0, 14, 8)' -stim_label 2 R8 \
		-stim_times 3 /home/despoB/kaihwang/bin/HTB_MRI/${s}_D1 'TENT(0, 14, 8)' -stim_label 3 D1 \
		-stim_times 4 /home/despoB/kaihwang/bin/HTB_MRI/${s}_D2 'TENT(0, 14, 8)' -stim_label 4 D2 \
